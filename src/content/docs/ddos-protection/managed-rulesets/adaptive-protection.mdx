...
:::note
The default rule action for `log` with a sensitivity set to `high` will only show packets with suspected attack traffic over certain thresholds in your logs.
:::
