...
description: Configure network segmentation with Cloudflare Magic WAN to control LAN traffic flow, enhance security, and manage policies for specific subnets.
---
